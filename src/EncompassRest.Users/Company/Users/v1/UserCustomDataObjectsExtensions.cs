...
{
    /// <summary>
    /// The User Custom Data Objects Api extension methods.
    /// </summary>
    public static class UserCustomDataObjectsExtensions
    {
        ...
        private static IUserCustomDataObjectsV1 GetV1(IUserCustomDataObjects customDataObjects)
        {
            ...
            {
                v1 = o.ExtensionData.GetOrAdd(() => new UserCustomDataObjectsV1(o.Client, o.UserApis, o.UserId));
            }
            else if (v1 == null)
            {
        ...
        /// </summary>
        /// <param name="customDataObjects">The User Custom Data Objects Api Object.</param>
