...
namespace EncompassRest.Loans
{
    ...
    {
        public JsonNullable<decimal?> AboveOrBelowRatePercent { get; set; }
        public string AdjustorCoverage { get; set; }
        public string AusRecommendation { get; set; }
        public JsonNullable<int?> BedroomsUnit1 { get; set; }
        public JsonNullable<int?> BedroomsUnit2 { get; set; }
        public JsonNullable<int?> BedroomsUnit3 { get; set; }
        public JsonNullable<int?> BedroomsUnit4 { get; set; }
        public string CertificateNumber { get; set; }
        public string CommitmentNumber { get; set; }
        public JsonNullable<bool?> CommunityLendingAfordableHousingInitiative { get; set; }
        public string ContactTitle { get; set; }
        public string ContractNumber { get; set; }
        public string CpmProjectId { get; set; }
        public string DuCaseIdLpAusKey { get; set; }
        public string FormNumber { get; set; }
        public JsonNullable<int?> GrossRentUnit1 { get; set; }
        public JsonNullable<int?> GrossRentUnit2 { get; set; }
        public JsonNullable<int?> GrossRentUnit3 { get; set; }
        public JsonNullable<int?> GrossRentUnit4 { get; set; }
        public string HomeBuyersOwnershipEducationCertificateInFile { get; set; }
        public string Id { get; set; }
        public string InsurerCode { get; set; }
        public JsonNullable<decimal?> InterestedPartyContributions { get; set; }
        ...
        public JsonNullable<int?> NumberOfBorrowers { get; set; }
        public JsonNullable<int?> NumberOfMonthsReserves { get; set; }
        public JsonNullable<decimal?> OriginalAmountOfFirstMortgage { get; set; }
        ...
        public JsonNullable<decimal?> Required { get; set; }
        ...
        public JsonNullable<decimal?> UnpaidBalance { get; set; }
        public JsonNullable<decimal?> Verified { get; set; }
    }
}