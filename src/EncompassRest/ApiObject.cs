...
namespace EncompassRest
{
    public abstract class ApiObject
    {
        ...
        internal Task PatchPopulateDirtyAsync(string requestUri, string queryString, HttpContent content, string methodName, string resourceId, CancellationToken cancellationToken, IDirty target, bool populate) => PopulateDirtyInternalAsync(s_patchMethod, requestUri, queryString, content, methodName, resourceId, cancellationToken, target, populate);
        ...
        internal Task PutPopulateDirtyAsync(string requestUri, string queryString, HttpContent content, string methodName, string resourceId, CancellationToken cancellationToken, IDirty target, bool populate) => PopulateDirtyInternalAsync(HttpMethod.Put, requestUri, queryString, content, methodName, resourceId, cancellationToken, target, populate);
        ...
        private Task PopulateDirtyInternalAsync(HttpMethod method, string requestUri, string queryString, HttpContent content, string methodName, string resourceId, CancellationToken cancellationToken, IDirty target, bool populate) => SendAsync(method, requestUri, queryString, content, methodName, resourceId, cancellationToken, async response =>
        {
            if (populate)
            {
