...
public sealed partial class Gfe2010 : DirtyExtensibleObject, IIdentifiable
{
    ...
    private DirtyValue<DateTime?>? _chargesDate;
    ...
    private DirtyValue<DateTime?>? _rateDate;
    ...
    /// <summary>
    /// Gfe2010Contract BorrowerSelectIndicator13
    /// </summary>
    ...
    /// </summary>
    public DateTime? ChargesDate { get => _chargesDate; set => SetField(ref _chargesDate, value); }
    ...
    /// </summary>
    public DateTime? RateDate { get => _rateDate; set => SetField(ref _rateDate, value); }
