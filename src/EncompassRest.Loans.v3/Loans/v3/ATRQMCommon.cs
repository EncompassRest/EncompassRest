...
public sealed partial class ATRQMCommon : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public string? AusDataDiscrepancyResolutionComments { get => GetValue<string?>(); set => SetValue(value); }

    /// <summary>
    /// AUS Data Discrepency Resolution Date [AUSF.X19]
    /// </summary>
    public DateTime? AusDataDiscrepancyResolutionDate { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// AUS Data Discrepency Resolution User [AUSF.X21]
    /// </summary>
    public string? AusDataDiscrepancyResolvedBy { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public bool? IsConsumerLikelyDefault { get => GetValue<bool?>(); set => SetValue(value); }
    ...
    /// </summary>
    public DateTime? LastMonthlyPaymentDate { get => GetValue<DateTime?>(); set => SetValue(value); }
