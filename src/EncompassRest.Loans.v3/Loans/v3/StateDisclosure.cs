...
public sealed partial class StateDisclosure : DirtyExtensibleObject, IIdentifiable
{
    ...
    private DirtyValue<bool?>? _kyHomeSolicitationLoanIndicator;
    ...
    private DirtyValue<StringEnumValue<ServicingFeePaidFrequence>>? _servicingFeePaidFrequency;
    ...
    /// </summary>
    public bool? KyHomeSolicitationLoanIndicator { get => _kyHomeSolicitationLoanIndicator; set => SetField(ref _kyHomeSolicitationLoanIndicator, value); }
    ...
    /// </summary>
    public string? RegulatorMailingState { get => _regulatorMailingState; set => SetField(ref _regulatorMailingState, value); }
    ...
    /// </summary>
    public string? RegulatorState { get => _regulatorState; set => SetField(ref _regulatorState, value); }
    ...
    /// </summary>
    public StringEnumValue<ServicingFeePaidFrequence> ServicingFeePaidFrequency { get => _servicingFeePaidFrequency; set => SetField(ref _servicingFeePaidFrequency, value); }
