...
public sealed partial class DisclosureNotices : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public string? CommitmentIssuedByState { get => _commitmentIssuedByState; set => SetField(ref _commitmentIssuedByState, value); }
    ...
    /// </summary>
    public string? EcoaState { get => _ecoaState; set => SetField(ref _ecoaState, value); }
