...
public sealed partial class Hud1Es : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public string? CityPropertyTaxState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? RealEstateTaxState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    [LoanFieldProperty(ReadOnly = true)]
    public string? ServicerState { get => GetValue<string?>(); set => SetValue(value); }
