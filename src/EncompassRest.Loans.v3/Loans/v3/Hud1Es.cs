...
public sealed partial class Hud1Es : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public string? CityPropertyTaxState { get => _cityPropertyTaxState; set => SetField(ref _cityPropertyTaxState, value); }
    ...
    /// </summary>
    public string? RealEstateTaxState { get => _realEstateTaxState; set => SetField(ref _realEstateTaxState, value); }
    ...
    /// </summary>
    [LoanFieldProperty(ReadOnly = true)]
    public string? ServicerState { get => _servicerState; set => SetField(ref _servicerState, value); }
