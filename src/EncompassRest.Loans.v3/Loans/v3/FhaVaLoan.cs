...
public sealed partial class FhaVaLoan : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public DateTime? ApprovalExpirationDate { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? BorrowerCertificationState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// <summary>
    /// FhaVaLoan EnergyEfficientMortgage
    /// </summary>
    [AllowNull]
    public EnergyEfficientMortgage EnergyEfficientMortgage { get => GetEntity<EnergyEfficientMortgage>(); set => SetEntity(value); }
    ...
    /// </summary>
    public DateTime? MortgageApprovedDate { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public DateTime? ServingTransferredDate { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? SponsorAgentState { get => GetValue<string?>(); set => SetValue(value); }
