...
public sealed partial class ElliLOCompensation : DirtyExtensibleObject, IIdentifiable
{
    ...
    private DirtyValue<DateTime?>? _lastAppliedDateTime;
    ...
    public DateTime? LastAppliedDateTime { get => _lastAppliedDateTime; set => SetField(ref _lastAppliedDateTime, value); }
