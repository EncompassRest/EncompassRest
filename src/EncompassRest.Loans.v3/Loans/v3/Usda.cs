...
public sealed partial class Usda : DirtyExtensibleObject, IIdentifiable
{
    ...
    private DirtyValue<DateTime?>? _confirmedObligationProcessedDate;
    ...
    private DirtyValue<DateTime?>? _loanNoteGuaranteeIssuedDate;
    private DirtyValue<DateTime?>? _loanNoteGuaranteeRequestReceivedDate;
    ...
    private DirtyValue<DateTime?>? _obligationInGlsDate;
    ...
    private DirtyValue<string?>? _previousLandlordZip;
    ...
    private DirtyValue<DateTime?>? _verifiedInUnifiDate;

    /// <summary>
    /// UsdaContract AdditionalIncomeFromPrimaryEmployment
    /// </summary>
    ...
    /// <summary>
    /// UsdaContract AdjustedAnnualIncome
    /// </summary>
    ...
    /// <summary>
    /// UsdaContract BorrowerBaseIncome
    /// </summary>
    ...
    /// </summary>
    public string? ChildCareProviderState { get => _childCareProviderState; set => SetField(ref _childCareProviderState, value); }
    ...
    /// <summary>
    /// UsdaContract CoborrowerBaseIncome
    /// </summary>
    ...
    /// </summary>
    public DateTime? ConfirmedObligationProcessedDate { get => _confirmedObligationProcessedDate; set => SetField(ref _confirmedObligationProcessedDate, value); }
    ...
    /// </summary>
    public DateTime? LoanNoteGuaranteeIssuedDate { get => _loanNoteGuaranteeIssuedDate; set => SetField(ref _loanNoteGuaranteeIssuedDate, value); }

    /// <summary>
    /// USDA - Tracking - DateLoan Note Guarantee Request Received [USDA.X157]
    /// </summary>
    public DateTime? LoanNoteGuaranteeRequestReceivedDate { get => _loanNoteGuaranteeRequestReceivedDate; set => SetField(ref _loanNoteGuaranteeRequestReceivedDate, value); }
    ...
    /// </summary>
    public DateTime? ObligationInGlsDate { get => _obligationInGlsDate; set => SetField(ref _obligationInGlsDate, value); }
    ...
    /// </summary>
    public string? PresentLandloardState { get => _presentLandloardState; set => SetField(ref _presentLandloardState, value); }
    ...
    /// </summary>
    public string? PreviousLandloardState { get => _previousLandloardState; set => SetField(ref _previousLandloardState, value); }

    /// <summary>
    /// USDA - Previous Landloard - Zip [USDA.X118]
    /// </summary>
    [LoanFieldProperty(Format = LoanFieldFormat.ZIPCODE)]
    public string? PreviousLandlordZip { get => _previousLandlordZip; set => SetField(ref _previousLandlordZip, value); }
    ...
    /// </summary>
    public string? SubmittingLenderState { get => _submittingLenderState; set => SetField(ref _submittingLenderState, value); }
    ...
    /// <summary>
    /// UsdaContract UsdaHouseholdIncomes
    /// </summary>
    [AllowNull]
    ...
    /// </summary>
    public DateTime? VerifiedInUnifiDate { get => _verifiedInUnifiDate; set => SetField(ref _verifiedInUnifiDate, value); }
}