...
public sealed partial class Tsum : DirtyExtensibleObject, IIdentifiable
{
    ...
    private DirtyValue<bool?>? _communityLendingAffordableHousingInitiative;
    ...
    /// </summary>
    public bool? CommunityLendingAffordableHousingInitiative { get => _communityLendingAffordableHousingInitiative; set => SetField(ref _communityLendingAffordableHousingInitiative, value); }
    ...
    /// </summary>
    public string? SellerState { get => _sellerState; set => SetField(ref _sellerState, value); }
