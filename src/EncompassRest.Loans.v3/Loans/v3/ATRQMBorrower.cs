...
public sealed partial class ATRQMBorrower : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public decimal? BorMonthlyEmploymentIncomeBaseIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Bonuses [QM.X139]
    /// </summary>
    public decimal? BorMonthlyEmploymentIncomeBonusIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Commissions [QM.X140]
    /// </summary>
    public decimal? BorMonthlyEmploymentIncomeCommissionIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Dividend and Interest [QM.X141]
    /// </summary>
    public decimal? BorMonthlyEmploymentIncomeDividendInterestIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Other Income 1 [QM.X142]
    /// </summary>
    public decimal? BorMonthlyEmploymentIncomeOtherIncome1 { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Other Income 2 [QM.X143]
    /// </summary>
    public decimal? BorMonthlyEmploymentIncomeOtherIncome2 { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Overtime [QM.X138]
    /// </summary>
    public decimal? BorMonthlyEmploymentIncomeOvertimeIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Total Monthly Employment Income [QM.X144]
    /// </summary>
    public decimal? BorMonthlyEmploymentIncomeTotalEmploymentIncome { get => GetValue<decimal?>(); set => SetValue(value); }
    ...
    /// </summary>
    public decimal? BorNonEmploymentIncomeHomeownerSubsidyIncome { get => GetValue<decimal?>(); set => SetValue(value); }
    ...
    /// </summary>
    public bool? BorNonEmploymentIncomeIsOffsetHomeownerSubsidyIncome { get => GetValue<bool?>(); set => SetValue(value); }
    ...
    /// </summary>
    public decimal? CobMonthlyEmploymentIncomeBaseIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Bonuses [QM.X147]
    /// </summary>
    public decimal? CobMonthlyEmploymentIncomeBonusIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Commissions [QM.X148]
    /// </summary>
    public decimal? CobMonthlyEmploymentIncomeCommissionIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Dividend and Interest [QM.X149]
    /// </summary>
    public decimal? CobMonthlyEmploymentIncomeDividendInterestIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Other Income 1 [QM.X150]
    /// </summary>
    public decimal? CobMonthlyEmploymentIncomeOtherIncome1 { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Other Income 2 [QM.X151]
    /// </summary>
    public decimal? CobMonthlyEmploymentIncomeOtherIncome2 { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Overtime [QM.X146]
    /// </summary>
    public decimal? CobMonthlyEmploymentIncomeOvertimeIncome { get => GetValue<decimal?>(); set => SetValue(value); }

    /// <summary>
    /// ATR/QM Management - Appendix Q - Income - Total Monthly Employment Income [QM.X152]
    /// </summary>
    public decimal? CobMonthlyEmploymentIncomeTotalEmploymentIncome { get => GetValue<decimal?>(); set => SetValue(value); }
    ...
    /// </summary>
    public decimal? CobNonEmploymentIncomeHomeownerSubsidyIncome { get => GetValue<decimal?>(); set => SetValue(value); }
