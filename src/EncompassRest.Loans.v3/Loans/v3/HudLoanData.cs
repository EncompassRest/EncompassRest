...
public sealed partial class HudLoanData : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public string? DealerContractorState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public DateTime? LeaseExpirationDate { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? PropertyOwnerState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public decimal? SupplementalOriginationFee { get => GetValue<decimal?>(); set => SetValue(value); }
