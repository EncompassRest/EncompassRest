...
public sealed partial class HudLoanData : DirtyExtensibleObject, IIdentifiable
{
    ...
    private DirtyValue<DateTime?>? _leaseExpirationDate;
    ...
    private DirtyValue<bool?>? _mtgOrDeedOfTrustOnProperty;
    ...
    private DirtyValue<decimal?>? _supplementalOriginationFee;
    ...
    /// </summary>
    public string? DealerContractorState { get => _dealerContractorState; set => SetField(ref _dealerContractorState, value); }
    ...
    /// </summary>
    public DateTime? LeaseExpirationDate { get => _leaseExpirationDate; set => SetField(ref _leaseExpirationDate, value); }
    ...
    /// </summary>
    public bool? MtgOrDeedOfTrustOnProperty { get => _mtgOrDeedOfTrustOnProperty; set => SetField(ref _mtgOrDeedOfTrustOnProperty, value); }
    ...
    /// </summary>
    public string? PropertyOwnerState { get => _propertyOwnerState; set => SetField(ref _propertyOwnerState, value); }
    ...
    /// <summary>
    /// HudLoanDataContract SecondaryFinancingProviders
    /// </summary>
    [AllowNull]
    ...
    /// </summary>
    public decimal? SupplementalOriginationFee { get => _supplementalOriginationFee; set => SetField(ref _supplementalOriginationFee, value); }
