...
public sealed partial class Application : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    [AllowNull]
    public ATRQMBorrower AtrqmBorrower { get => GetEntity<ATRQMBorrower>(); set => SetEntity(value); }

    /// <summary>
    /// Application AusTracking
    /// </summary>
    [AllowNull]
    public AusTracking AusTracking { get => GetEntity<AusTracking>(); set => SetEntity(value); }
    ...
    /// </summary>
    public string? EquifaxState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? ExperianState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    [AllowNull]
    public IList<GiftsGrants> GiftsGrants { get => GetList<GiftsGrants>(); set => SetList(value); }
    ...
    /// </summary>
    [AllowNull]
    public EntityReference LoanOfficer { get => GetEntity<EntityReference>(); set => SetEntity(value); }
    ...
    /// <summary>
    /// Application SelfEmployedIncome
    /// </summary>
    [AllowNull]
    public IList<SelfEmployedIncome> SelfEmployedIncome { get => GetList<SelfEmployedIncome>(); set => SetList(value); }
    ...
    /// </summary>
    public string? SofDBorrowerAddressState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? SofDCoBorrowerAddressState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    [AllowNull]
    public Tax4506Classic Tax4506 { get => GetEntity<Tax4506Classic>(); set => SetEntity(value); }
    ...
    /// <summary>
    /// Application Tax4506T
    /// </summary>
    [AllowNull]
    public Tax4506TClassic Tax4506T { get => GetEntity<Tax4506TClassic>(); set => SetEntity(value); }

    /// <summary>
    /// Application Tax4506Ts
    /// </summary>
    [AllowNull]
    public IList<Tax4506T> Tax4506Ts { get => GetList<Tax4506T>(); set => SetList(value); }
    ...
    /// </summary>
    [AllowNull]
    public IList<TqlReport> TqlReports { get => GetList<TqlReport>(); set => SetList(value); }
    ...
    /// </summary>
    public string? TransUnionState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    [AllowNull]
    public IList<Vod> Vods { get => GetList<Vod>(); set => SetList(value); }

    /// <summary>
    /// Application Vols
    /// </summary>
    [AllowNull]
    public IList<Vol> Vols { get => GetList<Vol>(); set => SetList(value); }
}