...
public sealed partial class InterimServicing : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    [AllowNull]
    public SchedulePaymentTransaction LastScheduledPayment { get => GetEntity<SchedulePaymentTransaction>(); set => SetEntity(value); }
    ...
    /// </summary>
    [AllowNull]
    public SchedulePaymentTransaction NextScheduledPayment { get => GetEntity<SchedulePaymentTransaction>(); set => SetEntity(value); }
