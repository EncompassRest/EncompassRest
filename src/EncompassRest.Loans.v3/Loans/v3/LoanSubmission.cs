...
public sealed partial class LoanSubmission : DirtyExtensibleObject, IIdentifiable
{
    ...
    private DirtyValue<DateTime?>? _lockDateTime;
    ...
    /// <summary>
    /// LoanSubmissionContract LoanSubmissionFees
    /// </summary>
    [AllowNull]
    ...
    public DateTime? LockDateTime { get => _lockDateTime; set => SetField(ref _lockDateTime, value); }
