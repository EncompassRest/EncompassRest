...
public sealed partial class Gfe : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public StringEnumValue<LoanFromBrokerControledFundsType> LoanFromBrokerControlledFundsType { get => GetValue<StringEnumValue<LoanFromBrokerControledFundsType>>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? MortgageBrokerCommissionFeePaidToName { get => GetValue<string?>(); set => SetValue(value); }
