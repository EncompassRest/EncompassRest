...
public sealed partial class Gfe : DirtyExtensibleObject, IIdentifiable
{
    ...
    private DirtyValue<StringEnumValue<LoanFromBrokerControledFundsType>>? _loanFromBrokerControlledFundsType;
    ...
    private DirtyValue<string?>? _mortgageBrokerCommissionFeePaidToName;
    ...
    /// </summary>
    public StringEnumValue<LoanFromBrokerControledFundsType> LoanFromBrokerControlledFundsType { get => _loanFromBrokerControlledFundsType; set => SetField(ref _loanFromBrokerControlledFundsType, value); }
    ...
    /// </summary>
    public string? MortgageBrokerCommissionFeePaidToName { get => _mortgageBrokerCommissionFeePaidToName; set => SetField(ref _mortgageBrokerCommissionFeePaidToName, value); }
