...
public sealed partial class RateLock : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public string? CompInvestorState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? CompSideComparisonBy { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? CorrespondentReconciliationComments { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? CorrespondentWarehouseBankState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<PartyType> FirstPaymentTo { get => GetValue<StringEnumValue<PartyType>>(); set => SetValue(value); }

    /// <summary>
    /// Purchase Advice Date First Payment to Investor [3514]
    /// </summary>
    public DateTime? FirstPaymentToInvestorDate { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? InvestorState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public DateTime? LockedWithInvestorDate { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    public DateTime? RequestFulfilledDateTime { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<ImpoundWaived> RequestImpoundWaived { get => GetValue<StringEnumValue<ImpoundWaived>>(); set => SetValue(value); }
    ...
    /// </summary>
    public DateTime? WarehousedDate { get => GetValue<DateTime?>(); set => SetValue(value); }
}