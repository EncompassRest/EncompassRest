...
/// </summary>
public sealed class LoanFields : ILoanFields
{
    ...
    public LoanField this[string fieldId]
    {
        get
        {
            ...
            if (fieldId.Length > 2 && fieldId[fieldId.Length - 2] == '#')
            {
                ...
                descriptor = LoanFieldDescriptors.GetFieldDescriptor(strippedFieldId, _loan.Client?.Loans.GetFieldDescriptors().CustomFields, UndefinedCustomFieldHandling.Default);
            ...
            {
                descriptor = LoanFieldDescriptors.GetFieldDescriptor(fieldId, _loan.Client?.Loans.GetFieldDescriptors().CustomFields, _loan.Client?.UndefinedCustomFieldHandling ?? UndefinedCustomFieldHandling.Default);
            }
    ...
    ILoanField ILoanFields.this[string fieldId] => this[fieldId];
