...
public sealed partial class Uldd : DirtyExtensibleObject, IIdentifiable
{
    ...
    private DirtyValue<StringEnumValue<FannieBuydownContributer>>? _fannieBuydownContributor;
    ...
    private DirtyValue<string?>? _freddieDownPmt3Amt;
    ...
    private DirtyValue<string?>? _freddieDownPmt4Amt;
    ...
    /// </summary>
    public StringEnumValue<FannieBuydownContributer> FannieBuydownContributor { get => _fannieBuydownContributor; set => SetField(ref _fannieBuydownContributor, value); }
    ...
    /// </summary>
    public string? FreddieDownPmt3Amt { get => _freddieDownPmt3Amt; set => SetField(ref _freddieDownPmt3Amt, value); }
    ...
    /// </summary>
    public string? FreddieDownPmt4Amt { get => _freddieDownPmt4Amt; set => SetField(ref _freddieDownPmt4Amt, value); }
    ...
    /// <summary>
    /// UlddContract FreddieRelatedLoanLienPosition [ULDD.X145], [ULDD.X146]
    /// </summary>
