...
namespace EncompassRest.Tests
{
    ...
    public class FilterTests
    {
        ...
        {
            var filter = new StringFieldFilter(LoanCanonicalField.LoanFolder, StringFieldMatchType.Exact, "Active Loans");
        ...
        {
            var filter = new StringFieldFilter(LoanCanonicalField.LoanFolder, StringFieldMatchType.Exact, "Active Loans")
                .And(new NumericFieldFilter(LoanCanonicalField.LoanAmount, OrdinalFieldMatchType.GreaterThanOrEquals, 80000M));
