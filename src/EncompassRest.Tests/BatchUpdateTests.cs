...
namespace EncompassRest.Tests
{
    ...
    public class BatchUpdateTests
    {
        ...
        {
            var batchUpdateParameters = new BatchUpdateParameters(new StringFieldFilter(LoanCanonicalField.LoanFolder, StringFieldMatchType.Exact, "Active Loans"), new Loan { Tltv = 85.00M });
