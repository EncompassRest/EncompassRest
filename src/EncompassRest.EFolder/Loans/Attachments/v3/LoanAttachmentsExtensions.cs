...
//        /// </summary>
//        public static ILoanAttachmentsV3? V1 { get; set; }

//        private static ILoanAttachmentsV3 GetV1(ILoanAttachments loanAttachments)
//        {
//            var v1 = V1;
//            if (loanAttachments is LoanAttachments a)
//            {
//                v1 = a.ExtensionData.GetOrAdd(() => new LoanAttachmentsV3(a.Client, a.LoanApis, a.LoanId));
//            }
//            else if (v1 == null)
//            {
