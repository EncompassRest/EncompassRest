...
namespace EncompassApi.Loans
{
    partial class Loan
    {
        ...
        /// <summary>
        /// The <see cref="IEncompassApiClient"/> associated with this object.
        /// </summary>
        [JsonIgnore]
        public IEncompassApiClient? Client { get; internal set; }
        ...
        /// </summary>
        /// <param name="client">The client to associate the object with.</param>
        public Loan(IEncompassApiClient client)
        {
        ...
        /// </summary>
        [JsonConstructor]
        [Obsolete("Use EncompassApiClient parameter constructor instead.")]
        ...
        /// <param name="client">The client to initialize the loan object with.</param>
        /// <param name="loanId">The loan id of the Encompass loan.</param>
        public void Initialize(IEncompassApiClient client, string loanId)
        {
            Preconditions.NotNull(client, nameof(client));
