...
namespace EncompassApi.Contacts
{
    ...
    public sealed class BorrowerContact : Contact
    {
        ...
        /// <param name="firstName">The contact's first name.</param>
        /// <param name="personalEmail">The contact's personal email address.</param>
        public BorrowerContact(EncompassApiClient client, string contactId, string firstName, string personalEmail)
        ...
        /// <param name="firstName">The contact's first name.</param>
        /// <param name="personalEmail">The contact's personal email address.</param>
        public BorrowerContact(IEncompassApiClient client, string contactId, string firstName, string personalEmail)
