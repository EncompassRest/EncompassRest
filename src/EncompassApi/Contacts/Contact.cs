...
namespace EncompassApi.Contacts
{
    ...
    public abstract class Contact : DirtyExtensibleObject, IIdentifiable
    {
        ...
        /// <summary>
        /// The <see cref="EncompassApiClient"/> associated with this object.
        /// </summary>
        [JsonIgnore]
        public IEncompassApiClient? Client { get; private set; }
        ...
        internal Contact(IEncompassApiClient client, string contactId, string firstName, string personalEmail)
        ...
        /// </summary>
        /// <param name="client">The <see cref="EncompassApiClient"/> to associate with this object.</param>
        /// <param name="contactId">The contactId (or id) is the unique identifier of the contact.</param>
        public void Initialize(EncompassApiClient client, string contactId) => Initialize((IEncompassApiClient)client, contactId);
        ...
        /// <param name="client">The <see cref="EncompassApiClient"/> to associate with this object.</param>
        /// <param name="contactId">The contactId (or id) is the unique identifier of the contact.</param>
        public void Initialize(IEncompassApiClient client, string contactId)
        {
