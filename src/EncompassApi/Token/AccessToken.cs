    ...
    public sealed class AccessToken : ApiObject, IAccessToken
    {
        ...
        internal HttpClient TokenClient
        {
            get
            {
                ...
                if (tokenClient == null)
                {
                    tokenClient = new HttpClient(new EncompassApiClient.RetryHandler(Client, false))
                    {
        ...
        internal AccessToken(string apiClientId, string apiClientSecret, EncompassApiClient client)
