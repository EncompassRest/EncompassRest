...
namespace EncompassApi.EFolder
{
    ...
    public sealed class ExportAttachmentsJob : ExtensibleObject
    {
        ...
        private IEncompassApiClient GetClient() => Client ?? throw new InvalidOperationException("ExportAttachmentsJob object must be initialized to refresh or download the attachment contents");
    }
}
