...
namespace EncompassRest.Settings.Contacts.v1
{
    ...
    internal abstract class ContactsSettingsV1 : ApiObject, IContactsSettingsV1
    {
        ...
        public Task<List<ContactFieldDefinition>> GetCanonicalNamesAsync(CancellationToken cancellationToken = default) => GetListAsync<ContactFieldDefinition>("fieldDefinitions", null, nameof(GetCanonicalNamesAsync), null, cancellationToken);
