...
namespace EncompassRest.Contacts.v1
{
    ...
    /// </summary>
    public interface IContactSelectorV1 : IApiObject
    {
        /// <summary>
    ...
    internal abstract class ContactSelectorV1 : ApiObject, IContactSelectorV1
    {
        internal ContactSelectorV1(EncompassRestClient client, string baseApiPath)
