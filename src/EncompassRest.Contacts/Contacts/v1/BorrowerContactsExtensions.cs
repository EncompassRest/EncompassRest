...
{
    /// <summary>
    /// The Borrower Contacts Api extension methods.
    /// </summary>
    public static class BorrowerContactsExtensions
    {
        ...
        private static IBorrowerContactsV1 GetV1(IBorrowerContacts borrowerContacts)
        {
            ...
            {
                v1 = c.ExtensionData.GetOrAdd(() => new BorrowerContactsV1(c.Client));
            }
            else if (v1 == null)
            {
        ...
        /// </summary>
        /// <param name="borrowerContacts">The Borrower Contacts Api Object.</param>
