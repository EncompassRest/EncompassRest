...
namespace EncompassRest
{
    public static class EntityGenerator
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, PropertySchema>> s_explicitPropertySchemas = new Dictionary<string, Dictionary<string, PropertySchema>>
        {
            ...
            { "Loan", new Dictionary<string, PropertySchema> { { "AlertChangeCircumstances", new PropertySchema { Type = PropertySchemaType.List, ElementType = "AlertChangeCircumstance" } }/*, { "AlertChangeCircumstanceApplyLECD", new PropertySchema { Type = PropertySchemaType.Bool } } // Not sure about the type here */ } },
            { "DisclosureTracking2015Log", new Dictionary<string, PropertySchema> { { "CureAppliedToLenderCredit", new PropertySchema { Type = PropertySchemaType.Decimal } }, { "CureAppliedToPrincipalReduction", new PropertySchema { Type = PropertySchemaType.Decimal } } } },
