...
namespace EncompassRest.Loans
{
    ...
    /// The loan field.
    /// </summary>
    public abstract class LoanFieldBase : ILoanField
    {
        internal readonly ILoan Loan;
        ...
        public virtual object? Value
        {
            ...
            set
            {
                ...
                if (value is LoanFieldBase loanField)
                {
        ...
        /// <inheritdoc/>
        public bool Locked => LockedInternal;

        internal abstract bool LockedInternal { get; }

        internal LoanFieldBase(FieldDescriptorBase descriptor, ILoan loan, ModelPath? modelPath = null, int? borrowerPairIndex = null)
        {
