...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public async Task Loan_BadUpdateException()
        {
            ...
            try
            {
                var ex = await Assert.ThrowsExceptionAsync<EncompassApiException>(() => client.Loans.UpdateLoanRawAsync(loanId, "{invalidJson}"));
                ...
                ex = await Assert.ThrowsExceptionAsync<EncompassApiException>(() => client.Loans.UpdateLoanAsync(loan));
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public async Task Loan_CheckKnownBadLockingFields()
        {
            ...
            try
            {
                ...
                {
                    await Assert.ThrowsExceptionAsync<EncompassApiException>(() =>
                    {
