...
namespace EncompassRest.LoanPipeline.v1
{
    ...
    /// </summary>
    public interface IPipelineV1 : IApiObject
    {
        /// <summary>
    ...
    internal sealed class PipelineV1 : ApiObject, IPipelineV1
    {
        internal PipelineV1(EncompassRestClient client)
        ...
        public Task<ILoanPipelineCursor> CreateCursorAsync(PipelineParameters parameters, bool? ignoreInvalidFields, CancellationToken cancellationToken = default)
        {
            ...
            return PostAsync(null, queryParameters.ToString(), JsonStreamContent.Create(parameters), nameof(CreateCursorAsync), null, cancellationToken, async response =>
            {
                ...
                return (ILoanPipelineCursor)new LoanPipelineCursor(this, cursorId, count, parameters.Fields);
            });
        }
