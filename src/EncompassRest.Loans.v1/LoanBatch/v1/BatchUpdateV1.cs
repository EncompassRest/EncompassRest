...
namespace EncompassRest.LoanBatch.v1
{
    ...
    /// </summary>
    public interface IBatchUpdateV1 : IApiObject
    {
        /// <summary>
    ...
    internal sealed class BatchUpdateV1 : ApiObject, IBatchUpdateV1
    {
        internal BatchUpdateV1(EncompassRestClient client)
        ...
        public Task<string> UpdateLoansAsync(BatchUpdateParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            return PostAsync(null, null, JsonStreamContent.Create(parameters), nameof(UpdateLoansAsync), null, cancellationToken, ApiObject.ReadLocationFunc);
        }
        ...
        public Task<string> UpdateLoansRawAsync(string parameters, string? queryString = null, CancellationToken cancellationToken = default)
        {
            ...
            return PostAsync(null, queryString, new JsonStringContent(parameters), nameof(UpdateLoansRawAsync), null, cancellationToken, ApiObject.ReadLocationFunc);
        }
    }
}