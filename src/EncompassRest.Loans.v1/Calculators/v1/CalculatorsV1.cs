...
namespace EncompassRest.Calculators.v1
{
    ...
    /// </summary>
    public interface ICalculatorsV1 : IApiObject
    {
        /// <summary>
    ...
    internal sealed class CalculatorsV1 : ApiObject, ICalculatorsV1
    {
        internal CalculatorsV1(EncompassRestClient client)
