...
public sealed partial class VaLoanData : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public StringEnumValue<State> AdministratorState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    [LoanFieldProperty(ReadOnly = true)]
    public StringEnumValue<State> ApplicantAddressState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    [LoanFieldProperty(ReadOnly = true)]
    public string? AvailableForInspectionDateAndTime { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    [LoanFieldProperty(ReadOnly = true)]
    public string? ContractNoApprovedByVA { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public DateTime? DateAquiredLand { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// VA Date of Assignment [415]
    /// </summary>
    public DateTime? DateOfAssignment { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// VA Loan Summ Date SAR Issued Value [VASUMM.X9]
    /// </summary>
    public DateTime? DateSAR { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public int? ExistingReasonableAppraisedValue { get => GetValue<int?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> POCState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<RiskClassification> RiskClasification { get => GetValue<StringEnumValue<RiskClassification>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<TypeOfOwnsership> TypeOfOwnsership { get => GetValue<StringEnumValue<TypeOfOwnsership>>(); set => SetValue(value); }
    ...
    /// </summary>
    public bool? VATrackingInuranceFloodPolicy { get => GetValue<bool?>(); set => SetValue(value); }

    /// <summary>
    /// VA Management Tool - Hazard Policy [VASUMM.X92]
    /// </summary>
    public bool? VATrackingInuranceHazardPolicy { get => GetValue<bool?>(); set => SetValue(value); }

    /// <summary>
    /// VA Management Tool - Wind/Hail Policy [VASUMM.X94]
    /// </summary>
    public bool? VATrackingInuranceWindOrHailPolicy { get => GetValue<bool?>(); set => SetValue(value); }

    /// <summary>
    /// VA Management Tool - Wood Destroying Policy [VASUMM.X93]
    /// </summary>
    public bool? VATrackingInuranceWoodDestroyingPolicy { get => GetValue<bool?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> WarrantorState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
