...
public sealed partial class LoanSubmission : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public DateTime? DateLastPaymentReceived { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    public DateTime? LockDateTimestampUtc { get => GetValue<DateTime?>(); set => SetValue(value); }
