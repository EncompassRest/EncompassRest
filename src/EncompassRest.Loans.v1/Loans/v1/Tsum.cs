...
public sealed partial class Tsum : DirtyExtensibleObject, IIdentifiable
{
    ...
    public bool? CommunityLendingAfordableHousingInitiative { get => GetValue<bool?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> SellerState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
