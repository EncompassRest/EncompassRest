...
public sealed partial class Contact : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public StringEnumValue<State> BizLicenseAuthStateCode { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public int? ContactIndex { get => GetValue<int?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> LicenseHomeState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> PersonalLicenseAuthStateCode { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
