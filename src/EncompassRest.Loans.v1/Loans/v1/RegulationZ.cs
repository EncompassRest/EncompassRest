...
public sealed partial class RegulationZ : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    [LoanFieldProperty(ReadOnly = true)]
    public string? BorrowerMiTerminationDate { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    [LoanFieldProperty(ReadOnly = true)]
    public string? MiScheduledTerminationDate { get => GetValue<string?>(); set => SetValue(value); }
