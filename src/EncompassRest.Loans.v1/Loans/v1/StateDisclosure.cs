...
public sealed partial class StateDisclosure : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    [LoanFieldProperty(OptionsJson = "{\"Y\":\"Y\",\"N\":\"N\"}")]
    public bool? KyHomeSolicationLoanIndicator { get => GetValue<bool?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> RegulatorMailingState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> RegulatorState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<ServicingFeePaidFrequence> ServicingFeePaidFrequence { get => GetValue<StringEnumValue<ServicingFeePaidFrequence>>(); set => SetValue(value); }
