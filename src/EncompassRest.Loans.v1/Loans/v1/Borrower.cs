...
public sealed partial class Borrower : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public string? AcountChekAssetId { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> BankContactState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public int? BorrowerIndex { get => GetValue<int?>(); set => SetValue(value); }
    ...
    /// </summary>
    public DateTime? DateAuthorizedCreditReport { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// Underwriting Date of Bankruptcy [2340]
    /// </summary>
    public DateTime? DateOfBankruptcy { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// Underwriting Date of Foreclosure [2341]
    /// </summary>
    public DateTime? DateOfForeclosure { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> NearestRelativeState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
