...
public sealed partial class Usda : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public StringEnumValue<State> ChildCareProviderState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public DateTime? DateConfirmedObligationProcessed { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// USDA - Tracking - Date Loan Note Guarantee Issued [USDA.X159]
    /// </summary>
    public DateTime? DateLoanNoteGuaranteeIssued { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// USDA - Tracking - DateLoan Note Guarantee Request Received [USDA.X157]
    /// </summary>
    public DateTime? DateLoanNoteGuaranteeRequestReceived { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// USDA - Tracking - Date of Obligation in GLS [USDA.X153]
    /// </summary>
    public DateTime? DateObligationInGls { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// USDA - Tracking - Date Verified in Unifi [USDA.X162]
    /// </summary>
    public DateTime? DateVerifiedInUnifi { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> PresentLandloardState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> PreviousLandloardState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }

    /// <summary>
    /// USDA - Previous Landloard - Zip [USDA.X118]
    /// </summary>
    [LoanFieldProperty(Format = LoanFieldFormat.ZIPCODE)]
    public string? PreviousLandloardZip { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> SubmittingLenderState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
