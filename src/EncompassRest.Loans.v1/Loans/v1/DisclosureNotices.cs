...
public sealed partial class DisclosureNotices : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public StringEnumValue<State> CommitmentIssuedByState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> EcoaState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
