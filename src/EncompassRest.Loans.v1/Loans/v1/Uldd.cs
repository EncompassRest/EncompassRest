...
public sealed partial class Uldd : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public StringEnumValue<FannieBuydownContributer> FannieBuydownContributer { get => GetValue<StringEnumValue<FannieBuydownContributer>>(); set => SetValue(value); }
    ...
    public StringEnumValue<LoanType> FannnieMortgageType { get => GetValue<StringEnumValue<LoanType>>(); set => SetValue(value); }
    ...
    /// </summary>
    public decimal? FreddieDownPmt3Amt { get => GetValue<decimal?>(); set => SetValue(value); }
    ...
    /// </summary>
    public decimal? FreddieDownPmt4Amt { get => GetValue<decimal?>(); set => SetValue(value); }
