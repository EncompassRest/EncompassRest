...
public sealed partial class Hmda : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public string? ApplicationDate { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// CLTV [HMDA.X37]
    /// </summary>
    public StringDecimalValue CLTV { get => GetValue<StringDecimalValue>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> ContactOfficeState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringDecimalValue DebtToIncomeRatio { get => GetValue<StringDecimalValue>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringDecimalValue DiscountPoints { get => GetValue<StringDecimalValue>(); set => SetValue(value); }
    ...
    public string? HMDAProfileApplicationDateValue { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> HmdaPropertyState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringDecimalValue InterestRate { get => GetValue<StringDecimalValue>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringDecimalValue LenderCredits { get => GetValue<StringDecimalValue>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<ManufacturedSecuredProperyType> ManufacturedSecuredProperyType { get => GetValue<StringEnumValue<ManufacturedSecuredProperyType>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringEnumValue<State> ParentState { get => GetValue<StringEnumValue<State>>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringDecimalValue PropertyValue { get => GetValue<StringDecimalValue>(); set => SetValue(value); }
    ...
    /// </summary>
    public StringDecimalValue RateSpread { get => GetValue<StringDecimalValue>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? RepurchasedActionDate { get => GetValue<string?>(); set => SetValue(value); }
