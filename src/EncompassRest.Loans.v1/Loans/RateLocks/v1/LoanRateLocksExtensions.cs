...
{
    /// <summary>
    /// The Loan Rate Locks Api extension methods.
    /// </summary>
    public static class LoanRateLocksExtensions
    {
        ...
        private static ILoanRateLocksV1 GetV1(ILoanRateLocks rateLocks)
        {
            ...
            {
                v1 = l.ExtensionData.GetOrAdd(() => new LoanRateLocksV1(l.Client, l.LoanApis, l.LoanId));
            }
            else if (v1 == null)
            {
        ...
        /// </summary>
        /// <param name="rateLocks">The Loan Rate Locks Api Object.</param>
