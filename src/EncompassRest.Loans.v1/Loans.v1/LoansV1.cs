...
namespace EncompassRest.Loans.v1
{
    ...
    internal sealed class LoansV1 : ApiObject, ILoansV1
    {
        ...
        public Task<string> GetSupportedEntitiesRawAsync(string? queryString = null, CancellationToken cancellationToken = default) => GetRawAsync("encompass/v1/loans/supportedEntities", queryString, nameof(GetSupportedEntitiesRawAsync), null, cancellationToken);
