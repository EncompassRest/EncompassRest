...
namespace EncompassRest.CustomDataObjects.v1
{
    ...
    /// </summary>
    public interface ICustomDataObjectsV1 : IApiObject
    {
        /// <summary>
    ...
    internal abstract class CustomDataObjectsV1 : ApiObject, ICustomDataObjectsV1
    {
        internal CustomDataObjectsV1(EncompassRestClient client, string baseApiPath)
